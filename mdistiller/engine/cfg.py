...
CFG.SOLVER.EPOCHS = 90
CFG.SOLVER.LR = 0.05
CFG.SOLVER.LR_DECAY_STAGES = [30, 50, 70]
CFG.SOLVER.LR_DECAY_RATE = 0.1
CFG.SOLVER.WEIGHT_DECAY = 0.0001
CFG.SOLVER.MOMENTUM = 0.9
CFG.SOLVER.TYPE = "SGD" 
CFG.SOLVER.LR_COS = False
CFG.SOLVER.MIN_LR = 0.00005  # The minimum learning rate of cosine annealing
CFG.SOLVER.WARMUP_EPOCHS = 20  # The number of warmup epochs
CFG.SOLVER.WARMUP_FACTOR = 0.1  # The warmup factor
# DEEPKD Solver CFG
CFG.SOLVER.DEEPKD = CN()

CFG.SOLVER.DEEPKD.DKD = False
CFG.SOLVER.DEEPKD.TOPK = 0
CFG.SOLVER.DEEPKD.CE_WEIGHT = 1.0
CFG.SOLVER.DEEPKD.ALPHA = 1.0
CFG.SOLVER.DEEPKD.BETA = 8.0
CFG.SOLVER.DEEPKD.WARMUP_FACTOR = 20

CFG.SOLVER.DEEPKD.DELTA_TOG = 0.075
CFG.SOLVER.DEEPKD.DELTA_TCG = -0.075  
CFG.SOLVER.DEEPKD.DELTA_NCG = 0.075   
